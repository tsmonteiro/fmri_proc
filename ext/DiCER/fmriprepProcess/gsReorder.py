...
def main(raw_args=None):
	...
	parser.add_argument("-f", dest="func",	help="functional MRI time series", metavar="fMRI")
	parser.add_argument("-ts", dest="dtissue",	help="tisue segmentation", metavar="dtissue.nii.gz")
	parser.add_argument("-of", dest="outputFileName",	help="Ordering filename", metavar="orderingFileName.nii.gz")
