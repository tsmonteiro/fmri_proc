...
SUB=$1
OUTDIR=$2
DATADIR=/media/u0101486/MONTEIRO/rsfMRI/$SUB
...
if [ ! -d "$DATADIR" ]; then
  ...
  matlab "-nodesktop -nosplash " <<<"cd './matlab'; p_reorient('${OUTDIR}/tmp_func_data_', '%03d.nii', 320); exit;"
  ...
  # COPY T1 File
    ...
    # SET Correct orientation
    matlab "-nodesktop -nosplash " <<<"cd './matlab'; p_reorient('${OUTDIR}/t1.nii'); exit;"
  ...
  matlab "-nodesktop -nosplash " <<<"cd './matlab'; reslice_images('${OUTDIR}/t1.nii',{'${OUTDIR}/t1.nii'}, 1, 0, [${SX} ${SY} ${SZ}]); exit;"
  ...
  matlab "-nodesktop -nosplash " <<<"cd './matlab'; reslice_images('${OUTDIR}/func_data.nii',{'${OUTDIR}/func_data.nii'}, 1, 0, [${SX} ${SY} ${SZ}]); exit;"
