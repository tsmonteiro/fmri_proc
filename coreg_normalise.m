...
if normalise(1) == 2
    ...
    matlabbatch{step}.spm.spatial.coreg.estwrite.roptions.interp = 0;
...
if normalise(2) == 1
    ...
    matlabbatch{step}.spm.spatial.preproc.tissue(1).tpm = {'/home/luna.kuleuven.be/u0101486/workspace/matlab/toolbox/spm12/tpm/TPM.nii,1'};
    ...
    matlabbatch{step}.spm.spatial.preproc.tissue(2).tpm = {'/home/luna.kuleuven.be/u0101486/workspace/matlab/toolbox/spm12/tpm/TPM.nii,2'};
    ...
    matlabbatch{step}.spm.spatial.preproc.tissue(3).tpm = {'/home/luna.kuleuven.be/u0101486/workspace/matlab/toolbox/spm12/tpm/TPM.nii,3'};
    ...
    matlabbatch{step}.spm.spatial.preproc.tissue(4).tpm = {'/home/luna.kuleuven.be/u0101486/workspace/matlab/toolbox/spm12/tpm/TPM.nii,4'};
    ...
    matlabbatch{step}.spm.spatial.preproc.tissue(5).tpm = {'/home/luna.kuleuven.be/u0101486/workspace/matlab/toolbox/spm12/tpm/TPM.nii,5'};
    ...
    matlabbatch{step}.spm.spatial.preproc.tissue(6).tpm = {'/home/luna.kuleuven.be/u0101486/workspace/matlab/toolbox/spm12/tpm/TPM.nii,6'};
